...
- **Monochrome 2 icon style** - A filled single-colour icon set, offered as Mono 2 next to Mono, Line and Classic in Settings and Themes. The ring and this window both use it; glyphs it does not cover come from the line family.
